...
fun MovieListScreen(navController: NavHostController) {
    ...
    callNowPlaying.enqueue(object : Callback<MovieReponse> {
        override fun onResponse(
            call: Call<MovieReponse>,
            response: Response<MovieReponse>
        ) {
            if (response.isSuccessful) {
                ...
                Log.e("MainActivity", "Request Error: ${response.errorBody()}")
            }
        }
    ...
    val callUpComingMovies = apiService.getUpcamingMovies()
    callUpComingMovies.enqueue(object : Callback<MovieReponse> {
        override fun onResponse(
            call: Call<MovieReponse>,
            response: Response<MovieReponse>
        ) {
    ...
    callTopRatedMovies.enqueue(object : Callback<MovieReponse> {
        override fun onResponse(
            call: Call<MovieReponse>,
            response: Response<MovieReponse>
        ) {
    ...
    callPopularMovies.enqueue(object : Callback<MovieReponse> {
        override fun onResponse(
            call: Call<MovieReponse>,
            response: Response<MovieReponse>
        ) {
